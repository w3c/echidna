    ...
    return List.of(
      ...
      step
        ...
        .then(obj => {
          ...
          if (obj.has('history'))
            state = state.addToHistory(obj.get('history'));
          if (obj.has('metadata')) {
...
Orchestrator.prototype.runDocumentDownloader = function (
  url,
  tar,
  tempLocation,
  httpLocation,
...
Orchestrator.prototype.runSpecberus = function (
  httpLocation,
  profile,
  recTrack,
  patentPolicy,
  ...
  return new Map({
    name: 'specberus',
    promise: SpecberusWrapper.validate(
      httpLocation,
      profile,
      recTrack,
      patentPolicy,
...
Orchestrator.prototype.runTransitionChecker = function (
  profile,
  latestVersion,
  previousVersion,
  isUpdate,
