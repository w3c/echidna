...
SpecberusWrapper.validate = (url, profile, isRecTrack, patentPolicy) =>
  new Promise((resolve, reject) => {
    ...
    if (profile === 'WD') {
      ...
      specberusProfile = require('specberus/lib/profiles/TR/NOTE-Echidna');
    } else if (profile === 'DNOTE') {
      specberusProfile = require('specberus/lib/profiles/TR/DNOTE-Echidna');
    } else if (profile === 'CR') {
