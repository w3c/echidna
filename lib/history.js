...
var History = function (facts) {
  if (typeof this !== 'object') throw new TypeError('History must be constructed via new');

  this.facts = typeof(facts) !== 'undefined' ? facts : Stack();
  if (!(this.facts instanceof Stack)) throw new TypeError('facts must be a Stack');
